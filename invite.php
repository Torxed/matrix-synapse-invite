<?php
	/*
		...
		Do not forget to change values:
		  ...
		  * $home_server_location (determains where to register the new user)
	...
	*/
	...
	if(!isset($_POST['username']) || !isset($_POST['password'])) {
		...
		?>
			...
			<body>
				<div id="content">
					<div class="logo"></div>
					<div class="fields">
						<form method="POST" action="./?K=<?php print $newKey; ?>"> <?php // We will inject a new key, and not the one the user got ?>
		...
		*/
		...
		// == General settings:
		$home_server_location = "https://homeserver.domain.com";
		...
		$curl = curl_init($home_server_location."/_matrix/client/api/v1/register");
